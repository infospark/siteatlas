from siteatlas.url_functions import get_scheme_and_domain, get_scheme_and_domain_and_path, get_absolute_url
...
def test_get_scheme_and_domain_from_http_url() -> None:
    ...
    scheme_and_domain = get_scheme_and_domain(http_url)
...
def test_get_scheme_and_domain_from_file_url() -> None:
    ...
    # When I get the scheme and domain from the url
    scheme_and_domain = get_scheme_and_domain(file_url)
    # Then I expect to get the scheme and domain
    assert scheme_and_domain == 'file://'
...
def test_strip_query_and_fragment_from_url() -> None:
    ...
    stripped_url = get_scheme_and_domain_and_path(test_url)
